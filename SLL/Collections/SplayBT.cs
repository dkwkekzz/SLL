...
namespace SLL.Collections
{
    ...
    public class SplayBT<TKey> : SplayBTBase<TKey>, IEnumerable<TKey>, IEnumerable
    {
        private sealed class _DefaultComparer : IComparer<TKey>
        {
        ...
        public SplayBT() : base(null, new _DefaultComparer())
        {
        }
        ...
        public SplayBT(int capacity) : base(createPool(capacity), new _DefaultComparer())
        {
        }
    ...
    {
        private sealed class _DefaultComparer : IComparer<KeyValuePair<TKey, TValue>>
        {
        ...
        private sealed class _PairComparer : IComparer<KeyValuePair<TKey, TValue>>
        {
            private IComparer<TKey> _comparer;

            public _PairComparer(IComparer<TKey> comparer)
            {
                _comparer = comparer;
            }
        ...
        public SplayBT(IComparer<TKey> comparer) : base(null, new _PairComparer(comparer))
        {
        }
        ...
        public SplayBT(int capacity, IComparer<TKey> comparer) : base(createPool(capacity), new _PairComparer(comparer))
        {
        }
    ...
    public abstract class SplayBTBase<TKey>
    {
        ...
        private static class EnumeratorHelper
        {
