...
namespace SLL.IO
{
    public struct Reader
    {
        ...
        public bool ReadBoolean(out bool ret)
        {
            ...
            ret = BitConverter.ToBoolean(_buffer, ref _offset);
            return true;
        }
        ...
        public bool ReadInt(out int ret)
        {
            ...
            ret = BitConverter.ToInt(_buffer, ref _offset);
            return true;
        }
        ...
        public bool ReadLong(out long ret)
        {
            ...
            ret = BitConverter.ToLong(_buffer, ref _offset);
            return true;
        }
        ...
        public bool ReadFloat(out float ret)
        {
            ...
            ret = BitConverter.ToSingle(_buffer, ref _offset);
            return true;
        }

        public bool ReadString(out string ret)
        {
            ret = BitConverter.ToString(_buffer, ref _offset);
            return true;
        }
